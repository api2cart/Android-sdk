...
public class AccountApi {
  ...
  */
  public AccountCartList200Response accountCartList (String params, String exclude, String requestFromDate, String requestToDate, String storeUrl, String storeKey) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
   ...
   * account.cart.list
   * This method lets you get a list of online stores connected to your API2Cart account. You can get the number of API requests to each store if you specify a period using parameters (request_from_date, request_to_date). The total_calls field is displayed only if there are parameters (request_from_date, request_to_date).
   * @param params Set this parameter in order to choose which entity fields you want to retrieve   * @param exclude Set this parameter in order to choose which entity fields you want to ignore. Works only if parameter &#x60;params&#x60; equal force_all   * @param requestFromDate Retrieve entities from their creation date   * @param requestToDate Retrieve entities to their creation date   * @param storeUrl A web address of a store   * @param storeKey Find store by store key
  */
  public void accountCartList (String params, String exclude, String requestFromDate, String requestToDate, String storeUrl, String storeKey, final Response.Listener<AccountCartList200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public AccountFailedWebhooks200Response accountFailedWebhooks (Integer count, Integer start, String ids) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
   ...
   * account.failed_webhooks
   * If the callback of your service for some reason could not accept webhooks from API2Cart, then with the help of this method you can get a list of missed webhooks to perform synchronization again using entity_id. Please note that we keep such records for 24 hours.
   * @param count This parameter sets the entity amount that has to be retrieved. Max allowed count&#x3D;250   * @param start This parameter sets the number from which you want to get entities   * @param ids List of сomma-separated webhook ids
  */
  public void accountFailedWebhooks (Integer count, Integer start, String ids, final Response.Listener<AccountFailedWebhooks200Response> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
