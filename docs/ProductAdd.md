...
**price** | [**BigDecimal**](BigDecimal.md) | Defines product&#39;s price that has to be added | 
...
**specialPrice** | [**BigDecimal**](BigDecimal.md) | Defines product&#39;s model that has to be added |  [optional]
**wholesalePrice** | [**BigDecimal**](BigDecimal.md) | Defines product&#39;s sale price |  [optional]
**costPrice** | [**BigDecimal**](BigDecimal.md) | Defines new product&#39;s cost price |  [optional]
**fixedCostShippingPrice** | [**BigDecimal**](BigDecimal.md) | Specifies product&#39;s fixed cost shipping price |  [optional]
...
**buyitnowPrice** | [**BigDecimal**](BigDecimal.md) | Defines buy it now value |  [optional]
**reservePrice** | [**BigDecimal**](BigDecimal.md) | Defines reserve price value |  [optional]
**quantity** | [**BigDecimal**](BigDecimal.md) | Defines product&#39;s quantity that has to be added |  [optional]
...
**maxOrderQuantity** | [**BigDecimal**](BigDecimal.md) | The maximum quantity an order can contain when purchasing the product. |  [optional]
...
**processingProfileId** | **Integer** | The numeric ID of the processing profile (readiness state) for physical products in Etsy. You can find possible values in the \&quot;cart.info\&quot; API method response, in the field processing_profiles[]-&gt;readiness_state_id. |  [optional]
