...
String shopeePartnerId = 1276777; // String | Shopee Partner ID
String shopeePartnerKey = 6a46494b4d746576554646626775617a577542774850636375464d6a736d5598; // String | Shopee Partner Key
String shopeeShopId = 137968; // String | Shopee SHOP ID
String shopeeRefreshToken = EAAPP06rM2n8BO4mZBuMPnu9zS0MaMbN7ue8aUkcxw4zewU987mVVb5br; // String | Shopee Refresh Token
String shopeeRegion = CN; // String | Shopee API endpoint Region. Use for Chinese Mainland or Brazil.
String shopeeEnvironment = sandbox; // String | Shopee Environment
...
String unasApiKey = c238908e29ceb6e6ad3df15f89a6234709d3f000; // String | UNAS API Key
...
String bigcartelUserName = subdomain; // String | Subdomain of store
String bigcartelPassword = 4GrrZCLNNoSUuhAjesKuchxo9SL; // String | BigCartel account password
String bricklinkConsumerKey = 26F6CDA087D9444EAA71AC09E7A1D39A; // String | Bricklink Consumer Key
String bricklinkConsumerSecret = a46abc3kxyinlbggy06i9g975xqo6gjq; // String | Bricklink Consumer Secret
String bricklinkToken = ktv4n9rgrj0evjuy2t6p2xlb1f8u5pmy; // String | Bricklink Access Token
String bricklinkTokenSecret = a46abc3kxyinlbggy06i9g975xqo6gjq; // String | Bricklink Access Token Secret
...
String temuAppKey = 4ebbc9190ae410443d65b4c2faca9811; // String | Temu App Key
String temuAppSecret = 4782d2d827276688bf4758bed55dbdd4bbe79a78; // String | Temu App Secret
String temuAccessToken = uplv3hfyt5kcwoymrgnajnbl1ow5qxlz4sqhev6hl3xosz5dejrtyl2jre6; // String | Temu Access Token
String temuRegion = US; // String | Temu API endpoint Region.
try {
