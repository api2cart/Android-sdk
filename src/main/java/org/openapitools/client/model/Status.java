...
public class Status {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? status.id == null : this.id.equals(status.id)) &&
        (this.name == null ? status.name == null : this.name.equals(status.name)) &&
        (this.additionalFields == null ? status.additionalFields == null : this.additionalFields.equals(status.additionalFields)) &&
        (this.customFields == null ? status.customFields == null : this.customFields.equals(status.customFields));
  }
